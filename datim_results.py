...
username = os.getenv("DATIM_USERNAME")
password = os.getenv("DATIM_PASSWORD")

uids = {
    "facility_results_uid": "OtdlVX7RHno",
    "community_results_uid": "RJMs1rX3GA5"
}

# Base URL template
base_url_template = "https://www.datim.org/api/dataValueSets?dataSet={uid}&startDate={startdate}&endDate={enddate}&orgUnit={orgunit}&children=true"
...
def create_table_if_not_exists():
    try:
        ...
        create_table_query = """
        CREATE TABLE IF NOT EXISTS datim_data (
