...
base_urls = {
    "dataElements": "https://hiskenya.org/api/dataElements?fields=id,name,shortName&paging=false",
    "categoryOptionCombos": "https://hiskenya.org/api/categoryOptionCombos?fields=id,name,shortName&paging=false",
    "organisationUnits": "https://hiskenya.org/api/organisationUnits/HfVjCurKxh2?fields=id,name,code&paging=false&includeDescendants=true",
}
...
def save_to_db(connection, table_name, data):
    ...
    if table_name == "organisationUnits":
        ...
        insert_query = f"INSERT INTO khis_{table_name} (id, name, short_name, code) VALUES (%s, %s, %s, %s)"
        ...
        insert_query = f"INSERT INTO khis_{table_name} (id, name, short_name) VALUES (%s, %s, %s)"
        cursor.executemany(insert_query, [
